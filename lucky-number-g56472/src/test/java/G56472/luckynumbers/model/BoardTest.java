...
import G56472.luckynumbers.model.Tile;
...
public class BoardTest {
    ...
    @Test
    public void canBePut_fullPlay_Bocked(){
    ...
    @Test
    public void canBePut_exception_case() {
        board.put(new Tile(5), new Position(1, 0));
        board.put(new Tile(11), new Position(2, 0));
        board.put(new Tile(15), new Position(3, 0));
        board.put(new Tile(16), new Position(3, 1));
        board.put(new Tile(14), new Position(2, 3));
        board.put(new Tile(13), new Position(2, 2));
        board.put(new Tile(17), new Position(3, 2));
        assertTrue(board.canBePut(new Tile(8), new Position(1, 3)));
    }
    /* === Tests for isFull === */
    @Test
